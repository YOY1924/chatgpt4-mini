    ...
    <div class="flex h-full">
      <div class="flex flex-col w-full max-w-md mx-8 sm:mx-18">
        <Show when={!props.isLogin()}>
          <div class="fi mt-12 ">
            <span class="text-(2xl transparent) font-extrabold bg-(clip-text gradient-to-r) from-sky-400 to-emerald-600">GPT-4o-mini & CHATXYZ</span>
          </div>
        ...
        <Show when={props.isLogin()}>
          ...
          <p class="mt-2 text-xs text-yellow-800">建议收藏永久入口: https://mini4.aichats.site 即可获取最新域名！请使用chrome浏览器获得最佳体验效果,其他浏览器可能因不兼容而无法响应</p>
